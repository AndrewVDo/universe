...
void create_demo1()
{
	...
	for (int i = 7; i < 350; i++)
	{
		solar_system->create_asteroid(rand() % 1200 - 600, rand() % 1200 - 600, 0, 0, 100000, rand()%5, Color::White); 
		solar_system->make_orbit(i, 0, 1);
	}

	//solar_system->create_planet(-1000, 300, 2.5, 0, 200000000000000, 50, Color::Cyan);
